...
class StorageManager:
    ...
    def __init__(self, database_directory):
        ...
        self.DEFAULT_MOVIES = pd.DataFrame(
            columns=[col.value for col in list(MovieColumns)]
        ...
        self.DEFAULT_NOMINATIONS = pd.DataFrame(
            columns=[col.value for col in list(NomColumns)]
        )
        ...
        self.DEFAULT_USERS = pd.DataFrame(
            columns=[col.value for col in list(UserColumns)]
        ...
        self.DEFAULT_CATEGORIES = pd.DataFrame(
            columns=[col.value for col in list(CategoryColumns)]
        ...
        self.DEFAULT_WATCHLIST = pd.DataFrame(
            columns=[col.value for col in list(WatchlistColumns)]
        )
