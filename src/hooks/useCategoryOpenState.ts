...
export function useCategoryOpenState(): [
  OpenState,
  (newOpenStateOrUpdater: OpenState | ((prev: OpenState) => OpenState)) => void,
] {
  ...
  const setOpenState = useCallback(
    (newOpenStateOrUpdater: OpenState | ((prev: OpenState) => OpenState)) => {
      const newOpenState =
        typeof newOpenStateOrUpdater === 'function'
