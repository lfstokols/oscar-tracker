...
import NotificationToast, { Notification, NotificationType } from './NotificationToast';
...
export function useNotifications(): NotificationsDispatch {
    ...
    const show = useCallback(
        ...
        }: NotificationDispatchArgs) => setActiveNotification({
            type,
            message,
            autoHideDurationMs: autoHideDurationMs === 0 ? null : autoHideDurationMs,
